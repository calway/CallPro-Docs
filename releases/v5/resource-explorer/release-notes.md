...
## v5.0.32 - 2026-03-17
### New
- In de Resource Explorer is nu ook een realtime belvloer overzicht opgenomen vergelijkbaar met het overzicht dat in CallProPortal beschikbaar is. Het belvloer overzixcht is te vinden in het control panel. ![alt text](media/5.0.32-belvloer-overzicht.png) 
